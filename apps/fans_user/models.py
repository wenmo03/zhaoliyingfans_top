...
class UserOfWeibo(models.Model):
    ...
    head = models.CharField(max_length=232, null=True, blank=True, verbose_name='头像50')
    head_large = models.CharField(max_length=232, null=True, blank=True, verbose_name='头像180')
